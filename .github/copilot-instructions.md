...
Read and follow `/AGENTS.md` before changing this repository. It is the source of truth for the
local-reading fork scope, project-wide constraints, source priority, validation, current Android
boundaries, and the KMP/CMP direction.
...
`gradle/libs.versions.toml`. Any described KMP target structure is a staged proposal, not a
description of modules that already exist.
